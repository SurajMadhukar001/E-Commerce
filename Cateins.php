...
// }
$selectquery="SELECT * FROM `category` WHERE Name='$category_tittle'";
...
echo "This Category Already Exists";
  ...
  $insert_query="INSERT INTO `category` (Name) VALUES ('$category_tittle')";
  $result=mysqli_query($connection,$insert_query);
  if ($result){
...
<div class="input-group mb-5">
  ...
  <input type="text" name="cate" class="form-control" placeholder="Insert The Category" aria-label="Username" aria-describedby="basic-addon1">
</div>
